      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-lg-2">
            <h1 class="mb-0 site-logo"><a href="https://www.rayosxvillanueva.com" class="mb-0">MAXLEX GEO</a></h1>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-lg-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active"><a href="https://www.rayosxvillanueva.com" class="nav-link">Inicio</a></li>
            ...
            <div class="row site-section pt-0">
              <div class="col-md-4 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled">
                  <li><a style="color: #FFF;" href="https://www.rayosxvillanueva.com">Inicio</a></li>
