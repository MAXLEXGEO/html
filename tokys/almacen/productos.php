<?php
  ...
  $almacen_productos = 'active is-shown';
?>
<!DOCTYPE html>
  ...
  <body class="animsition dashboard">
    ...
    <div class="page">
      <div class="page-header">
        <h1 class="page-title blue-500">Productos</h1>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="javascript:void(0)">Almacén</a></li>
          <li class="breadcrumb-item active">Productos</li>
        </ol>
        <div class="page-header-actions">
          <button class="btn btn-sm bg-blue-700 btn-round white" data-target="#modal_producto_nuevo" data-target-file="productos_modal_nueva" data-toggle="modal">
    ...
    <div class="modal fade example-modal-sm" id="modal_producto_nuevo" aria-hidden="true" aria-labelledby="modal_producto_nuevo" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-simple modal-sm" id="modal_producto_nuevo_content">
      </div>
    </div>
    <!-- End Modal -->

    <!-- Modal - Editar producto -->
    <div class="modal fade example-modal-sm" id="modal_producto_editar" aria-hidden="true" aria-labelledby="modal_producto_editar" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-simple modal-sm" id="modal_producto_editar_content">
      </div>
    </div>
    <!-- End Modal -->
    ...
    <!-- Functions -->
    <script src="../assets/scripts/js/f_productos.js"></script>
  </body>
</html>