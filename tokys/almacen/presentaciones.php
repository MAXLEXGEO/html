<?php
  ...
  $almacen_presentaciones = 'active is-shown';
?>
<!DOCTYPE html>
<html class="no-js css-menubar" lang="es">
  <head>
    ...
    <title>Almacen | Presentaciones</title>
  ...
  <body class="animsition dashboard">
    ...
    <div class="page">
      <div class="page-header">
        <h1 class="page-title blue-500">Presentaciones</h1>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="javascript:void(0)">Almacén</a></li>
          <li class="breadcrumb-item active">Presentaciones</li>
        </ol>
        <div class="page-header-actions">
          <button class="btn btn-sm bg-blue-700 btn-round white" data-target="#modal_pre_nueva" data-target-file="presentaciones_modal_nueva" data-toggle="modal">
      ...
      <div class="page-content">
        ...
        <div class="panel">
          ...
          <div class="panel-body" id="tabla_presentaciones">
          </div>
        </div>
        <!-- End Panel Basic -->
      </div>
    ...
    <!-- Modal - Agregar marca -->
    <div class="modal fade example-modal-sm" id="modal_pre_nueva" aria-hidden="true" aria-labelledby="modal_pre_nueva" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-simple modal-sm" id="modal_pre_nueva_content">
      </div>
    </div>
    <!-- End Modal -->

    <!-- Modal - Editar marca -->
    <div class="modal fade example-modal-sm" id="modal_pre_editar" aria-hidden="true" aria-labelledby="modal_pre_editar" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-simple modal-sm" id="modal_pre_editar_content">
      </div>
    </div>
    <!-- End Modal -->
    ...
    <!-- Functions -->
    <script src="../assets/scripts/js/f_presentaciones.js"></script>
  </body>
</html>