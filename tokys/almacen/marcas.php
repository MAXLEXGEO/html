<?php
  ...
  $almacen_marcas = 'active is-shown';
?>
<!DOCTYPE html>
  ...
  <body class="animsition dashboard">
    ...
    <div class="page">
      <div class="page-header">
        <h1 class="page-title blue-500">Marcas</h1>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="javascript:void(0)">Almacén</a></li>
          <li class="breadcrumb-item active">Marcas</li>
        </ol>
        <div class="page-header-actions">
          <button class="btn btn-sm bg-blue-700 btn-round white" data-target="#modal_marca_nueva" data-target-file="marcas_modal_nueva" data-toggle="modal">
      ...
      <div class="page-content">
        ...
        <div class="panel">
          ...
          <div class="panel-body" id="tabla_marcas">
          </div>
        </div>
        <!-- End Panel Basic -->
      </div>
    ...
    <!-- Modal - Agregar marca -->
    <div class="modal fade example-modal-sm" id="modal_marca_nueva" aria-hidden="true" aria-labelledby="modal_marca_nueva" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-simple modal-sm" id="modal_marca_nueva_content">
      </div>
    </div>
    <!-- End Modal -->

    <!-- Modal - Editar marca -->
    <div class="modal fade example-modal-sm" id="modal_marca_editar" aria-hidden="true" aria-labelledby="modal_marca_editar" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-simple modal-sm" id="modal_marca_editar_content">
      </div>
    </div>
    <!-- End Modal -->
    ...
    <!-- Functions -->
    <script src="../assets/scripts/js/f_marcas.js"></script>
  </body>
</html>