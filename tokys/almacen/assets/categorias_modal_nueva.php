<div class="modal-content">
  <div class="modal-header bg-blue-300">
    <h4 class="modal-title white">Agregar Categoría</h4>
  </div>
  <div class="modal-body">
    <div class="modal-body">
      <form id="form_nueva_categoria" autocomplete="off" action="#">
        <div class="row row-lg">
          ...
          <div class="form-group form-material col-xl-12 text-right padding-top-m">
            <button type="button" class="btn btn-sm btn-round bg-blue-700 white" id="btn_agregar_categoria" onclick="agregar_categoria();">Agregar</button>
