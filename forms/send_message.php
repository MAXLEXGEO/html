...
$username = 'amirsha@maxlexgeo.com';
...
if(strlen($_POST['lock']) > 0){
	...
	$mail->addAddress('contacto@maxlexgeo.com');
	$mail->addBCC('alikey01@gmail.com');                     
	...
	$mail->Subject = $_POST['subject'].' | Mensaje de contacto desde maxlexgeo.com';
